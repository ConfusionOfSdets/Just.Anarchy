...
namespace Just.Anarchy.Test.Unit.Exceptions.Handlers.ExceptionHandler
{
    ...
    public class HandleAsyncTests
    {
        ...
        private static readonly object[] HandleAsyncPassingCases =
        {
            ...
            new object[] { new ScheduleMissingExceptionHandler(new FakeLogger<ScheduleMissingException>()), new ScheduleMissingException(), "schedule-not-set", StatusCodes.Status400BadRequest },
